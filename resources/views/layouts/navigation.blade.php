<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <!-- ↓一覧ページへのリンクを追加 -->
        <div class="pt-2 pb-3 space-y-1">
          <x-responsive-nav-link :href="route('runner.index')" :active="request()->routeIs('runner.index')">
            {{ __('Index') }}
          </x-responsive-nav-link>
        </div>
        <!-- ↓作成ページへのリンクを追加 -->
        <div class="pt-2 pb-3 space-y-1">
          <x-responsive-nav-link :href="route('runner.create')" :active="request()->routeIs('runner.create')">
            {{ __('Create') }}
          </x-responsive-nav-link>
        </div>
        <!-- ↓計測ページへのリンクを追加 -->
